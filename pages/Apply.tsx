...
import { Briefcase, MapPin, Calendar, Clock, ArrowLeft, Upload, CheckCircle, AlertCircle, FileText, X } from 'lucide-react';
...
const Apply: React.FC = () => {
    ...
    const handleCvChange = (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        if (file) {
            ...
            if (!isValidType) {
                setFormErrors(prev => ({ ...prev, cv: `Please upload a PDF or Word document. Received: ${file.type || 'unknown type'}` }));
                return;
            }
        ...
        return (
            <div className="min-h-screen bg-gradient-to-br from-kemu-purple/5 via-white to-kemu-gold/5">
                <div className="container mx-auto px-4 py-16 text-center">
                    ...
                    <Link to="/careers" className="text-kemu-purple hover:underline">
                        ← Back to Careers
                    </Link>
                </div>
            </div>
        ...
        <div className="min-h-screen bg-gradient-to-br from-kemu-purple/5 via-white to-kemu-gold/5">
            ...
            <div className="bg-gradient-to-r from-kemu-purple via-kemu-purple to-kemu-blue text-white py-12">
                <div className="container mx-auto px-4">
                    <Link to="/careers" className="inline-flex items-center text-white/80 hover:text-white mb-4 transition-colors">
                        <ArrowLeft size={20} className="mr-2" />
                        Back to Careers
                    </Link>
                    <h1 className="text-3xl md:text-4xl font-bold mb-2">Apply for Position</h1>
                    <p className="text-white/80">Complete the form below to submit your application</p>
                </div>
            </div>
